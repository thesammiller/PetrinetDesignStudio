"""
This script is called by the plugin-wrapper, MarkedGraph.js, which passes down the
...
plugin = MarkedGraph(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
