"""
This script is called by the plugin-wrapper, WorkflowNet.js, which passes down the
...
from WorkflowNet import WorkflowNet
...
plugin = WorkflowNet(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
