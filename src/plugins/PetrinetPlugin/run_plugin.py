"""
This script is called by the plugin-wrapper, PetrinetPlugin.js, which passes down the
...
from PetrinetPlugin import PetrinetPlugin
...
plugin = PetrinetPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
