"""
This script is called by the plugin-wrapper, FreeChoice.js, which passes down the
...
from FreeChoice import FreeChoice
...
plugin = FreeChoice(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
